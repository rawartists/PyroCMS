...
<fieldset>
    ...
    <p>
        ...
        <?php echo $page->type ? $page->type->title : null; ?>
    </p>
</fieldset>
...
<div class="buttons">
    ...
    if (isset($pageTypesCount) and $pageTypesCount > 1) {
        echo anchor(
        ...
        $typeId = isset($firstPageType) ? $firstPageType->id : null;
        echo anchor(
            'admin/pages/create?parent=' . $page->id . '&page_type=' . $typeId,
            lang('pages:create_label'),
            'class="btn btn-sm btn-warning"'
        );
    }
    ...
    ?>
    <?php echo anchor(
        'admin/pages/duplicate/' . $page->id,
        lang('pages:duplicate_label'),
        'class="btn btn-sm btn-warning"'
    ) ?>
    ...
    <?php echo anchor(
        ...
        lang('global:delete'),
        'class="confirm btn btn-sm btn-danger"'
    ) ?>
</div>
